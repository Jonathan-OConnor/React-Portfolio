            ...
            <div className="row" style={{ width: "100%" }}>
                ...
                <div className="row">
                    ...
                    <div className="text-center" style={{ marginTop: "100px" }}>
                        <Button variant="contained" color="primary" style={{ height: "50px", width: "150px", margin: "0px" }}>Download Resume</Button>
                        <Button onClick={props.redirect} variant="contained" color="primary" style={{ height: "50px", width: "150px", margin: "50px" }}>Contact</Button>
                    </div>
